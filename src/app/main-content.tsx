      ...
      <ChatProvider projectId={project?.id} initialMessages={project?.messages}>
        <div className="h-screen w-screen overflow-hidden bg-neutral-50">
          <ResizablePanelGroup id="main-panel-group" direction="horizontal" className="h-full">
            ...
            <ResizableHandle id="main-resize-handle" className="w-[1px] bg-neutral-200 hover:bg-neutral-300 transition-colors" />
                ...
                <div className="flex-1 overflow-hidden bg-neutral-50">
                  {activeView === "preview" ? (
                    ...
                    >
                      ...
                      <ResizableHandle id="code-resize-handle" className="w-[1px] bg-neutral-200 hover:bg-neutral-300 transition-colors" />
