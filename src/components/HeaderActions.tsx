      ...
      <>
        <div className="flex gap-2">
          ...
          <button
            ...
            className="h-8 px-4 rounded-lg text-[13px] font-semibold text-white transition-all duration-150 shadow-md hover:shadow-lg"
            ...
            onMouseLeave={e => (e.currentTarget as HTMLElement).style.boxShadow = "0 2px 8px rgba(124,58,237,0.35)"}
          >
            Sign Up
          </button>
        </div>
