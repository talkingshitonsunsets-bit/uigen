...
// Mock ToolCallBadge so MessageList tests aren't coupled to its internals
vi.mock("../ToolCallBadge", () => ({
  ToolCallBadge: ({ tool }: { tool: { toolName: string } }) => (
    <div data-testid="tool-call-badge">{tool.toolName}</div>
  ),
}));
